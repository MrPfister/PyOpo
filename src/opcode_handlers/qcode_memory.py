...
def qcode_pokeb(procedure, data_stack, stack):
    val = stack.pop()
    addr = stack.pop()
...
def qcode_poke(procedure, data_stack, stack):
...
def qcode_peekb(procedure, data_stack, stack):
    addr = stack.pop()
...
def qcode_peekw(procedure, data_stack, stack):
    addr = stack.pop()
...
def qcode_peekf(procedure, data_stack, stack):
    addr = stack.pop()
...
def qcode_alloc(procedure, data_stack, stack):
    size = stack.pop()
...
def qcode_peek_str(procedure, data_stack, stack):
    addr = stack.pop()
