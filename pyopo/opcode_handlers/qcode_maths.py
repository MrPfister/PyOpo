...
def qcode_cmp_mult(procedure, data_stack: data_stack, stack: stack):
    # print(f"{hex(op_code)} - push+ pop+2 * pop+1")
...
def qcode_cmp_div(procedure, data_stack: data_stack, stack: stack):
    # print(f"{hex(op_code)} - push+ pop+2 / pop+1")
...
def qcode_flt(procedure, data_stack: data_stack, stack: stack):
